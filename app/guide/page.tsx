  ...
  return <main className="guide-page">
    <div className="guide-wrap">
      ...
      {topic === 'sections' && <section>
        <div className="guide-callout">This is a section directory based on published stadium locations, not a scaled walking map. A match in the same zone means a broad area only.</div>
